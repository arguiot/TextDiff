...
class SwiftDiffTests: XCTestCase {
    ...
    func testDiffCommonPrefix() {
        ...
        // Null case.
        XCTAssertEqual(0, "abc".commonPrefix(with: "xyz").count)
        
        // Non-null case.
        XCTAssertEqual(4, "1234abcdef".commonPrefix(with: "1234xyz").count)
        
        // Whole case.
        XCTAssertEqual(4, "1234".commonPrefix(with: "1234xyz").count)
    }
    
    func testDiffCommonSuffix() {
        // Detect any common suffix.
        // Null case.
        XCTAssertEqual(0, "abc".commonSuffix(with: "xyz").count)
        
        // Non-null case.
        XCTAssertEqual(4, "abcdef1234".commonSuffix(with: "xyz1234").count)
        
        // Whole case.
        XCTAssertEqual(4, "1234".commonSuffix(with: "xyz1234").count)
    }
    
    func testDiffCommonOverlap() {
        // Detect any suffix/prefix overlap.
        // Null case.
        XCTAssertEqual(0, "".commonOverlapLength(with: "abcd"));
        
        // Whole case.
        XCTAssertEqual(3, "abc".commonOverlapLength(with: "abcd"));
        
        // No overlap.
        XCTAssertEqual(0, "123456".commonOverlapLength(with: "abcd"));
        
        // Overlap.
        XCTAssertEqual(3, "123456xxx".commonOverlapLength(with: "xxxabcd"));
        
        // Unicode.
        // Some overly clever languages (C#) may treat ligatures as equal to their
        // component letters.  E.g. U+FB01 == 'fi'
        XCTAssertEqual(0, "fi".commonOverlapLength(with: "\u{fb01}i"));
    }
